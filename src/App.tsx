...
export default function App() {
  const { scene, setScene, introComplete, squad, milestones, achievements, updateSquad } = useGameStore();
    ...
    switch (scene) {
      ...
      case 'squad':
        return (
          ...
          >
            <div className="flex gap-8 overflow-x-auto no-scrollbar px-12 pb-12 snap-x snap-center max-w-full">
              {squad.map((player) => (
                <div key={player.name} className="snap-center">
      ...
      case 'timeline':
        return <EraTimeline key="timeline" milestones={milestones} />;
      case 'achievements':
        return (
          <motion.div 
            key="achievements"
